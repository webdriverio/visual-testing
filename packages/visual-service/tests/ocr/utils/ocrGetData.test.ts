...
import * as WebDriverImageComparisonUtils from 'webdriver-image-comparison/dist/helpers/utils'
import { describe, it, expect, vi, beforeEach } from 'vitest'
import ocrGetData from '../../../src/ocr/utils/ocrGetData.js'
import * as Tesseract from '../../../src/ocr/utils/tesseract.js'
import * as ImageProcessing from '../../../src/ocr/utils/imageProcessing.js'
import { isRectanglesObject, adjustElementBbox } from '../../../src/ocr/utils/index.js'

const browser = wdioBrowser
const log = logger('test')
vi.mock('@wdio/logger', () => import(join(process.cwd(), '__mocks__', '@wdio/logger')))

vi.mock('../../../src/ocr/utils/tesseract.js')
...
describe('ocrGetData', () => {
    ...
    it('processes OCR data correctly using system Tesseract when available', async () => {
        ...
        expect(WebDriverImageComparisonUtils.getScreenshotSize).toHaveBeenCalledWith('screenshotData')
