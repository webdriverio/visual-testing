...
export function itFunction({ additionalSearchParams, clip, clipSelector, folders: { baselineFolder }, framework, skipStories, storyData, storybookUrl }: CreateItContent) {
    ...
    // Serializing the SearchParams to be easily passed in the generated it function
    // This is deserialized in the waitForStorybookComponentToBeLoaded function
    const stringifiedAdditionalSearchParams = additionalSearchParams.toString()
    ...
    ${itText}(\`should take a${screenshotType} screenshot of ${id}\`, async () => {
        await browser.waitForStorybookComponentToBeLoaded({
            ...
            additionalSearchParams: '${stringifiedAdditionalSearchParams}',
        });
        ${clip
...
export async function waitForStorybookComponentToBeLoaded(
    ...
    if (isStorybook) {
        const {
            additionalSearchParams: additionalSearchParamsString,
        ...
        const additionalSearchParams = new URLSearchParams(additionalSearchParamsString)
