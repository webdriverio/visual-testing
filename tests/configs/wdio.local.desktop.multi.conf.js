...
// Capabilities
// ============
config.specs = ['./tests/specs/multiremote.spec.js']
...
config.before = async (capabilities) => {
    ...
    chromeBrowserOne.logName = getLogName(
        capabilities.chromeBrowserOne.capabilities
    )
    chromeBrowserTwo.logName = getLogName(
        capabilities.chromeBrowserTwo.capabilities
    )
