...
import saveTabbable from 'webdriver-image-comparison/build/commands/saveTabbable'
import checkTabbable from 'webdriver-image-comparison/build/commands/checkTabbable'
...
export default class WdioImageComparisonService extends BaseClass {
    ...
    before(capabilities) {
         ...
         */
        browser.addCommand('saveTabbable', function (tag, saveTabbableOptions = {}) {
            return saveTabbable({
                executor: this.execute.bind(browser),
                screenShot: this.takeScreenshot.bind(browser),
            },
         ...
         */
        browser.addCommand('checkTabbable', function (tag, checkTabbableOptions = {}) {
            return checkTabbable({
                executor: this.execute.bind(browser),
                screenShot: this.takeScreenshot.bind(browser),
            },
            instanceData,
