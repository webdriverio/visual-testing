...
export function getFolders(methodOptions, folders) {
    return {
        actualFolder: methodOptions.actualFolder
            ? methodOptions.actualFolder
            : folders.actualFolder,
        baselineFolder: methodOptions.baselineFolder
            ? methodOptions.baselineFolder
            : folders.baselineFolder,
        diffFolder: methodOptions.diffFolder
            ? methodOptions.diffFolder
            : folders.diffFolder,
    }
}
...
export function getInstanceData(capabilities, currentBrowser) {
    ...
    const currentCapabilities =
        (currentBrowser && currentBrowser.capabilities) || browser.capabilities
    const browserName = (
    ...
    const platformVersion = (
        ...
        currentCapabilities.platformVersion ||
        'not-known'
    ).toLowerCase()
    const deviceName = (
    ...
    const nativeWebScreenshot =
        !!capabilities.nativeWebScreenshot ||
        !!capabilities['appium:nativeWebScreenshot']
